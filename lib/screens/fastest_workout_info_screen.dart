...
class FastestWorkoutInfoScreen extends StatefulWidget {
  static const String ID = "/fastest_workout_info_screen";
  @override
  _FastestWorkoutInfoScreenState createState() => _FastestWorkoutInfoScreenState();
}

class _FastestWorkoutInfoScreenState extends State<FastestWorkoutInfoScreen> {
                ...
                WorkoutInfoCard(
                  ...
                  onChanged: (dynamic value) {
                    setState(() {
                      ...
                      FastestWorkout.bicepReps = Constants.fastestWorkoutValues[0].round();
                    });
                  },
                ),
                SizedBox(height: 8),
                WorkoutInfoCard(
                  ...
                  onChanged: (dynamic value) {
                    setState(() {
                      ...
                      FastestWorkout.bicepWt = Constants.fastestWorkoutValues[1].round();
                    });
                  },
                ),
                SizedBox(height: 8),
                WorkoutInfoCard(
                  ...
                  onChanged: (dynamic value) {
                    setState(() {
                      ...
                      FastestWorkout.pushUpReps = Constants.fastestWorkoutValues[2].round();
                    });
                  },
                ),
                SizedBox(height: 8),
                WorkoutInfoCard(
                  ...
                  onChanged: (dynamic value) {
                    setState(() {
                      ...
                      FastestWorkout.pushUpWt = Constants.fastestWorkoutValues[3].round();
                    });
                  },
                ),
                SizedBox(height: 8),
                WorkoutInfoCard(
                  ...
                  onChanged: (dynamic value) {
                    setState(() {
                      ...
                      FastestWorkout.kettleReps = Constants.fastestWorkoutValues[4].round();
                    });
                  },
                ),
                SizedBox(height: 8),
                WorkoutInfoCard(
                  ...
                  onChanged: (dynamic value) {
                    setState(() {
                      ...
                      FastestWorkout.kettleLbs = Constants.fastestWorkoutValues[5].round();
                    });
                  },
                ),
                SizedBox(height: 8),
                  ...
                  child: RoundedButton(
                      ...
                      onPressed: () async {
                        ...
                        Navigator.pushNamed(context, WorkoutSummaryScreen.workoutSummaryScreenID,
                            arguments: ['Fastest Workout', Constants.fastestWorkoutValues]);
                      }),
                ),
                SizedBox(height: 10),
              ],
